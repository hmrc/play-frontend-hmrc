...
import uk.gov.hmrc.hmrcfrontend.views.viewmodels.caseworkerbanner.Generators._

object HmrcCaseworkerBannerIntegrationSpec
    extends MessagesAwareTemplateIntegrationSpec[CaseworkerBanner, HmrcCaseworkerBanner](hmrcComponentName =
