  ...
  "HmrcStandardHeader" should {
    ...
    "include the fallback image wrapped for IE8" in {
      ...
      content should include(
        """<img src="/some-service/hmrc-frontend/assets/govuk/images/govuk-logotype-tudor-crown.png" class="govuk-header__logotype-crown-fallback-image" width="36" height="32" alt="">"""
      )
    }
