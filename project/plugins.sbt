...
sys.env.get("PLAY_VERSION") match {
  ...
  case _           => addSbtPlugin("org.playframework" % "sbt-plugin" % "3.0.2") // moving to 3.0.3 will break since Templates no longer implement Template trait: https://github.com/playframework/twirl/commit/75eec7cf46e23f0d10fa0a7f24d2f9b44c6c9738
}
