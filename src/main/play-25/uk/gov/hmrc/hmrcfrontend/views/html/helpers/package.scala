...
import uk.gov.hmrc.hmrcfrontend.config.{AccessibilityStatementConfig, TrackingConsentConfig, ContactFrontendConfig}
...
package object helpers {
  ...
  lazy val HmrcReportTechnicalIssueHelper = hmrcReportTechnicalIssueHelper
}