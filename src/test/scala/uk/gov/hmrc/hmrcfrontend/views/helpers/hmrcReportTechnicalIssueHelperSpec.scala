...
class hmrcReportTechnicalIssueHelperSpec
  ...
  "HmrcReportTechnicalIssueHelper" should {
    "render link with the configured serviceId" in {
      ...
      links.first.attr(
        "href"
      )   shouldBe "https://www.tax.service.gov.uk/contact/problem_reports_nonjs?newTab=true&service=online-payments&referrerUrl=https%3A%2F%2Fwww.tax.service.gov.uk%2Ffoo"
    }
    ...
    "use contact-frontend host if platform host is not set" in {
      ...
      links.first.attr(
        "href"
      )   shouldBe "http://localhost:9999/contact/problem_reports_nonjs?newTab=true&service=online-payments&referrerUrl=%2Ffoo"
    }
