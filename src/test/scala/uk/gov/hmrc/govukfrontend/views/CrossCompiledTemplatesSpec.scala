...
class CrossCompiledTemplatesSpec extends WordSpec with Matchers {
  ...
  val playDir: String = BuildInfo.playVersion match {
    ...
    case "Play26" => "play-26"
    case "Play27" => "play-27"
    case _        => throw new IllegalArgumentException("Expecting Play25, Play26 or Play27")
  }
  ...
  val otherPlayDir: String = playDir match {
    ...
    case _         => throw new IllegalArgumentException("Expecting play-25, play-26 or play-27")
  }
