...
import uk.gov.hmrc.govukfrontend.views.viewmodels.template.Generators._

import scala.util.Try

object govukTemplateIntegrationSpec
    extends TemplateIntegrationSpec[Template](govukComponentName = "govukTemplate", seed = None) {
