...
- Bug fix: Removed additional ")" from `HmrcStandardHeader` that was being output to page
- Bumped `hmrc-frontend` version to latest (`7.3.0`)
...
- Updated standard beta phase banner to from `[..] give your feedback by email` to `[...] give your feedback (opens in new tab).`
...
- Refactoring of some JSON reads / writes (this change only affects library development and testing, no changes for services)
...
- Updated hmrc-frontend to v6.107.0 (no changes to `play-frontend-hmrc` as part of this uplift)
...
- Updated hmrc-frontend to v6.105.0 - fix for fix in previous release (sign out 
  link positioned incorrectly in header if no service name)

### Compatible with

- [hmrc/hmrc-frontend v6.105.0](https://github.com/hmrc/hmrc-frontend/releases/tag/v6.105.0)
- [alphagov/govuk-frontend v5.13.0](https://github.com/alphagov/govuk-frontend/releases/tag/v5.13.0)
...
- Updated hmrc-frontend to v6.104.0

### Compatible with

- [hmrc/hmrc-frontend v6.104.0](https://github.com/hmrc/hmrc-frontend/releases/tag/v6.104.0)
- [alphagov/govuk-frontend v5.13.0](https://github.com/alphagov/govuk-frontend/releases/tag/v5.13.0)
...
- Updated content for Phase Banner.

### Compatible with

- [hmrc/hmrc-frontend v6.102.0](https://github.com/hmrc/hmrc-frontend/releases/tag/v6.102.0)
- [alphagov/govuk-frontend v5.13.0](https://github.com/alphagov/govuk-frontend/releases/tag/v5.13.0)
...
- Dropped support for Play 2.9. Library will now build for Play 3.0.
...
- Bumped `hmrc-frontend` to `v6.102.0`, pulling in updated print styles
- Updated `HmrcInternalHeader` to take in optional `containerClasses` parameter
...
- [hmrc/hmrc-frontend v6.97.0](https://github.com/hmrc/hmrc-frontend/releases/tag/v6.97.0)
- [alphagov/govuk-frontend v5.13.0](https://github.com/alphagov/govuk-frontend/releases/tag/v5.13.0)
...
- Bumped version of Play library and `play-language`
...
- `hmrc-frontend` upgrade to 6.97.0
- `govuk-frontend` upgrade to 5.13.0
...
- Play Framework upgrade to 3.0.8
- hmrc-frontend upgrade to 6.95.0

### Compatible with

- [hmrc/hmrc-frontend v6.95.0](https://github.com/hmrc/hmrc-frontend/releases/tag/v6.95.0)
- [alphagov/govuk-frontend v5.12.0](https://github.com/alphagov/govuk-frontend/releases/tag/v5.12.0)

## [12.16.0] - 2025-09-29

### Changed

- Added config based feature flag to help with upcoming migration to using service navigation to display service name and language switcher

### Compatible with

- [hmrc/hmrc-frontend v6.94.0](https://github.com/hmrc/hmrc-frontend/releases/tag/v6.94.0)
- [alphagov/govuk-frontend v5.12.0](https://github.com/alphagov/govuk-frontend/releases/tag/v5.12.0)
...
- Updated `hmrc-frontend` to v6.94.0
- Updated `govuk-frontend` to v5.12.0
...
- Added implicit helper for service navigation language toggle
...
- Added `useDeprecatedPositionForHmrcBanner` argument to `HmrcStandardHeader`
...
- Updated `hmrc-frontend` to v6.78.0
- Updated `govuk-frontend` to v5.11.1
- Small fixes for Service Navigation and colours

### Compatible with

- [hmrc/hmrc-frontend v6.78.0](https://github.com/hmrc/hmrc-frontend/releases/tag/v6.78.0)
- [alphagov/govuk-frontend v5.11.1](https://github.com/alphagov/govuk-frontend/releases/tag/v5.11.1)
...
- Change made to a JSON reader for testing only purposes
...
- Updated `hmrc-frontend` to v6.65.0
- This introduces accessibility fixes for timeout-dialog on small screens

### Compatible with

- [hmrc/hmrc-frontend v6.62.0](https://github.com/hmrc/hmrc-frontend/releases/tag/v6.65.0)
...
- Dropped support for Play 2.8. Library will now cross-build for Play 2.9 and Play 3.0
- Updated `hmrc-frontend` to v6.62.0

### Compatible with

- [hmrc/hmrc-frontend v6.62.0](https://github.com/hmrc/hmrc-frontend/releases/tag/v6.62.0)
- [alphagov/govuk-frontend v5.9.0](https://github.com/alphagov/govuk-frontend/releases/tag/v5.9.0)
...
- Updated `hmrc-frontend` version to `6.53.0`, reverts a change to accessible autocomplete
...
- Updated `hmrc-frontend` version to `6.52.0`, pulls in a further accessible autocomplete update
- Updated `govuk-frontend` version to `5.8.0`

### Compatible with

- [hmrc/hmrc-frontend v6.52.0](https://github.com/hmrc/hmrc-frontend/releases/tag/v6.52.0)
- [alphagov/govuk-frontend v5.8.0](https://github.com/alphagov/govuk-frontend/releases/tag/v5.8.0)
...
- Updated `hmrc-frontend` version to `6.50.0`, pulls in timeout dialog fixes, updates accessible autocomplete

### Compatible with

- [hmrc/hmrc-frontend v6.50.0](https://github.com/hmrc/hmrc-frontend/releases/tag/v6.50.0)
...
- Updated `hmrc-frontend` version to `6.46.0`, removes backlink referer security checks to improve user experience

### Compatible with

- [hmrc/hmrc-frontend v6.46.0](https://github.com/hmrc/hmrc-frontend/releases/tag/v6.46.0)
- [alphagov/govuk-frontend v5.7.1](https://github.com/alphagov/govuk-frontend/releases/tag/v5.7.1)
...
- Updated `hmrc-frontend` version to `6.39.0` to fix broken fallback images

### Compatible with

- [hmrc/hmrc-frontend v6.39.0](https://github.com/hmrc/hmrc-frontend/releases/tag/v6.39.0)
- [alphagov/govuk-frontend v5.7.1](https://github.com/alphagov/govuk-frontend/releases/tag/v5.7.1)
...
- Uplifted version of `hmrc-frontend` to `v6.29.0`
...
- [hmrc/hmrc-frontend v6.22.0](https://github.com/hmrc/hmrc-frontend/releases/tag/v6.22.0)
